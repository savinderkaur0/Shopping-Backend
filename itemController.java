...
public class itemController {
    ...
    public String store(@RequestParam String name, @RequestParam Double price, @RequestParam String details, @RequestParam String image,@RequestParam  String category,@RequestParam String subCategory) {
        items p =itemservice.store(name,price,details,image,category,subCategory);
        return p.toString();
    }
    ...
    public List getAllItems()
  {
    ...
    @RequestMapping(value="/deleteByCategory/{subCategory}",method=RequestMethod.GET)
