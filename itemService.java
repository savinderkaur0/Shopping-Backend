...
public class itemService {
    ...
    public items  store(String name,Double price,String details,String image,String category,String subCategory)
    {
        return itemrepository.save(new items(name,price,details,image,category,subCategory));
    }
